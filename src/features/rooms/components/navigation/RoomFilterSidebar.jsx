...
const RoomFilterSidebar = () => {
  ...
  return (
    <aside className="rounded-xl bg-white shadow-sm overflow-hidden border border-[#C6C6C6] lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-6.5rem)] flex flex-col">
      ...
      {/* Filters Content */}
      <div className="flex-1 min-h-0 overflow-y-auto p-5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#990011] [&::-webkit-scrollbar-track]:bg-gray-200 [&::-webkit-scrollbar]:w-1.5">
        {/* Level Filter */}
        <LevelFilter />
